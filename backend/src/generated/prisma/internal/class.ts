...
/**
  ...
  /**
   * `prisma.envelopeMonth`: Exposes CRUD operations for the **EnvelopeMonth** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more EnvelopeMonths
    * const envelopeMonths = await prisma.envelopeMonth.findMany()
    * ```
    */
  get envelopeMonth(): Prisma.EnvelopeMonthDelegate<ExtArgs, { omit: OmitOpts }>;
   ...
   * `prisma.budgetMonth`: Exposes CRUD operations for the **BudgetMonth** model.
    ...
    * ```
    */
  get budgetMonth(): Prisma.BudgetMonthDelegate<ExtArgs, { omit: OmitOpts }>;
